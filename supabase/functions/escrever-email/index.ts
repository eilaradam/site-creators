    ...
    const sistema = [
      ...
      formato === "dm"
        ...
        ? [
            ...
            "   E se a conexao dela JA COUBE dentro da apresentacao, que e o que acontece com o nicho no modelo padrao, devolva motivo VAZIO. Repetir o nicho em duas linhas seguidas e o erro mais comum aqui.",
            ...
            "",
            "O MODELO PADRAO, que e o alvo quando a creator tem numeros. Siga essa forma, so trocando os dados pelos dela:",
            "+ de XX conteúdos criados só no último ano. ✨",
            "Oie, equipe! Cheguei 🎬 Sou criadora de conteúdo UGC, com mais de X marcas trabalhadas e especialista no nicho <o nicho dela ou o da marca>.",
            "Adoraria fazer parte desse trabalho e construir algo incrível juntos! Animada para iniciarmos.",
            "",
