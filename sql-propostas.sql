...
values ('cliente-mirielesousa', 'Miriele Sousa', 'Beauty & Wellness', 'enviado', '', '{"contexto":["Suas marcas de beauty precisam de criativo novo toda semana pra não saturar a mídia paga, e isso significa volume real de UGC rodando o tempo todo.","Cada campanha exige falar com 20, 30 creators diferentes: filtro, briefing, follow-up, revisão, NF. É operação demais pra quem precisa estar pensando em estratégia.","Marca de beauty tem nuance: pele, idade, rotina, perfil. Curadoria errada queima orçamento e não converte. Curadoria certa é o que diferencia campanha boa de campanha medíocre."],"frase":"Você passa o briefing da marca. Eu devolvo os vídeos prontos pra entrar no ar. Tudo no meio (seleção de creator, alinhamento, produção, revisão, NF, direito de uso) fica do meu lado.","pacotes":[{"creators":30,"videosCreator":1,"valorVideo":450,"gestaoPct":20},{"creators":15,"videosCreator":2,"valorVideo":400,"gestaoPct":20},{"creators":10,"videosCreator":1,"valorVideo":450,"gestaoPct":25},{"creators":5,"videosCreator":2,"valorVideo":400,"gestaoPct":25}],"videos":["i62BOlzvQlo","15nOoGJ872g","ATz4wOA_mAc","r-n9UcOlC24"],"validade":"Esta proposta é válida por 15 dias a partir do envio.","cronograma":"Início em até 5 dias úteis após aprovação · entrega conforme o escopo."}'::jsonb, now())
